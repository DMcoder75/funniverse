 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var q0;function uS(){if(q0)return ge;q0=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(L){return L===null||typeof L!="object"?null:(L=v&&L[v]||L["@@iterator"],typeof L=="function"?L:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,A={};function y(L,Z,dt){this.props=L,this.context=Z,this.refs=A,this.updater=dt||S}y.prototype.isReactComponent={},y.prototype.setState=function(L,Z){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,Z,"setState")},y.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function _(){}_.prototype=y.prototype;function V(L,Z,dt){this.props=L,this.context=Z,this.refs=A,this.updater=dt||S}var P=V.prototype=new _;P.constructor=V,E(P,y.prototype),P.isPureReactComponent=!0;var D=Array.isArray,N={H:null,A:null,T:null,S:null,V:null},F=Object.prototype.hasOwnProperty;function U(L,Z,dt,mt,bt,$){return dt=$.ref,{$$typeof:s,type:L,key:Z,ref:dt!==void 0?dt:null,props:$}}function z(L,Z){return U(L.type,Z,void 0,void 0,void 0,L.props)}function w(L){return typeof L=="object"&&L!==null&&L.$$typeof===s}function R(L){var Z={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(dt){return Z[dt]})}var G=/\/+/g;function Y(L,Z){return typeof L=="object"&&L!==null&&L.key!=null?R(""+L.key):Z.toString(36)}function tt(){}function rt(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(tt,tt):(L.status="pending",L.then(function(Z){L.status==="pending"&&(L.status="fulfilled",L.value=Z)},function(Z){L.status==="pending"&&(L.status="rejected",L.reason=Z)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function at(L,Z,dt,mt,bt){var $=typeof L;($==="undefined"||$==="boolean")&&(L=null);var ut=!1;if(L===null)ut=!0;else switch($){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(L.$$typeof){case s:case t:ut=!0;break;case g:return ut=L._init,at(ut(L._payload),Z,dt,mt,bt)}}if(ut)return bt=bt(L),ut=mt===""?"."+Y(L,0):mt,D(bt)?(dt="",ut!=null&&(dt=ut.replace(G,"$&/")+"/"),at(bt,Z,dt,"",function(Tt){return Tt})):bt!=null&&(w(bt)&&(bt=z(bt,dt+(bt.key==null||L&&L.key===bt.key?"":(""+bt.key).replace(G,"$&/")+"/")+ut)),Z.push(bt)),1;ut=0;var ht=mt===""?".":mt+":";if(D(L))for(var vt=0;vt<L.length;vt++)mt=L[vt],$=ht+Y(mt,vt),ut+=at(mt,Z,dt,$,bt);else if(vt=x(L),typeof vt=="function")for(L=vt.call(L),vt=0;!(mt=L.next()).done;)mt=mt.value,$=ht+Y(mt,vt++),ut+=at(mt,Z,dt,$,bt);else if($==="object"){if(typeof L.then=="function")return at(rt(L),Z,dt,mt,bt);throw Z=String(L),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return ut}function O(L,Z,dt){if(L==null)return L;var mt=[],bt=0;return at(L,mt,"","",function($){return Z.call(dt,$,bt++)}),mt}function X(L){if(L._status===-1){var Z=L._result;Z=Z(),Z.then(function(dt){(L._status===0||L._status===-1)&&(L._status=1,L._result=dt)},function(dt){(L._status===0||L._status===-1)&&(L._status=2,L._result=dt)}),L._status===-1&&(L._status=0,L._result=Z)}if(L._status===1)return L._result.default;throw L._result}var I=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)};function pt(){}return ge.Children={map:O,forEach:function(L,Z,dt){O(L,function(){Z.apply(this,arguments)},dt)},count:function(L){var Z=0;return O(L,function(){Z++}),Z},toArray:function(L){return O(L,function(Z){return Z})||[]},only:function(L){if(!w(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},ge.Component=y,ge.Fragment=i,ge.Profiler=l,ge.PureComponent=V,ge.StrictMode=r,ge.Suspense=m,ge.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=N,ge.__COMPILER_RUNTIME={__proto__:null,c:function(L){return N.H.useMemoCache(L)}},ge.cache=function(L){return function(){return L.apply(null,arguments)}},ge.cloneElement=function(L,Z,dt){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var mt=E({},L.props),bt=L.key,$=void 0;if(Z!=null)for(ut in Z.ref!==void 0&&($=void 0),Z.key!==void 0&&(bt=""+Z.key),Z)!F.call(Z,ut)||ut==="key"||ut==="__self"||ut==="__source"||ut==="ref"&&Z.ref===void 0||(mt[ut]=Z[ut]);var ut=arguments.length-2;if(ut===1)mt.children=dt;else if(1<ut){for(var ht=Array(ut),vt=0;vt<ut;vt++)ht[vt]=arguments[vt+2];mt.children=ht}return U(L.type,bt,void 0,void 0,$,mt)},ge.createContext=function(L){return L={$$typeof:f,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:c,_context:L},L},ge.createElement=function(L,Z,dt){var mt,bt={},$=null;if(Z!=null)for(mt in Z.key!==void 0&&($=""+Z.key),Z)F.call(Z,mt)&&mt!=="key"&&mt!=="__self"&&mt!=="__source"&&(bt[mt]=Z[mt]);var ut=arguments.length-2;if(ut===1)bt.children=dt;else if(1<ut){for(var ht=Array(ut),vt=0;vt<ut;vt++)ht[vt]=arguments[vt+2];bt.children=ht}if(L&&L.defaultProps)for(mt in ut=L.defaultProps,ut)bt[mt]===void 0&&(bt[mt]=ut[mt]);return U(L,$,void 0,void 0,null,bt)},ge.createRef=function(){return{current:null}},ge.forwardRef=function(L){return{$$typeof:h,render:L}},ge.isValidElement=w,ge.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:X}},ge.memo=function(L,Z){return{$$typeof:p,type:L,compare:Z===void 0?null:Z}},ge.startTransition=function(L){var Z=N.T,dt={};N.T=dt;try{var mt=L(),bt=N.S;bt!==null&&bt(dt,mt),typeof mt=="object"&&mt!==null&&typeof mt.then=="function"&&mt.then(pt,I)}catch($){I($)}finally{N.T=Z}},ge.unstable_useCacheRefresh=function(){return N.H.useCacheRefresh()},ge.use=function(L){return N.H.use(L)},ge.useActionState=function(L,Z,dt){return N.H.useActionState(L,Z,dt)},ge.useCallback=function(L,Z){return N.H.useCallback(L,Z)},ge.useContext=function(L){return N.H.useContext(L)},ge.useDebugValue=function(){},ge.useDeferredValue=function(L,Z){return N.H.useDeferredValue(L,Z)},ge.useEffect=function(L,Z,dt){var mt=N.H;if(typeof dt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return mt.useEffect(L,Z)},ge.useId=function(){return N.H.useId()},ge.useImperativeHandle=function(L,Z,dt){return N.H.useImperativeHandle(L,Z,dt)},ge.useInsertionEffect=function(L,Z){return N.H.useInsertionEffect(L,Z)},ge.useLayoutEffect=function(L,Z){return N.H.useLayoutEffect(L,Z)},ge.useMemo=function(L,Z){return N.H.useMemo(L,Z)},ge.useOptimistic=function(L,Z){return N.H.useOptimistic(L,Z)},ge.useReducer=function(L,Z,dt){return N.H.useReducer(L,Z,dt)},ge.useRef=function(L){return N.H.useRef(L)},ge.useState=function(L){return N.H.useState(L)},ge.useSyncExternalStore=function(L,Z,dt){return N.H.useSyncExternalStore(L,Z,dt)},ge.useTransition=function(){return N.H.useTransition()},ge.version="19.1.1",ge}var Y0;function Kh(){return Y0||(Y0=1,hd.exports=uS()),hd.exports}var Jt=Kh(),pd={exports:{}},Vo={},md={exports:{}},gd={};/**
 * @license React
...
`)+`
`+_);const P=V+y+f,D=V+_+h,N=q_(l,l.VERTEX_SHADER,P),F=q_(l,l.FRAGMENT_SHADER,D);l.attachShader(A,N),l.attachShader(A,F),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function U(G){if(s.debug.checkShaderErrors){const Y=l.getProgramInfoLog(A)||"",tt=l.getShaderInfoLog(N)||"",rt=l.getShaderInfoLog(F)||"",at=Y.trim(),O=tt.trim(),X=rt.trim();let I=!0,pt=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(I=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,N,F);else{const L=j_(l,N,"vertex"),Z=j_(l,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
